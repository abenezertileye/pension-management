...
if (isset($_POST['submit'])) {
    ...
    $next_page = $_POST['next_page'] ?? 'beneficiery.php';
...
<head>
    <title>Choose Company for Beneficiary</title>
...
<body>
    ...
    <div class="sidebar">
        <?php if ($roles['role'] == "Admin") { ?>
            ...
            <a href="choose_company.php?next=pensioner.php">Register new pensioner</a>
            <a href="choose_company_2.php?next=beneficiery.php">Register Beneficiary</a>
            ...
            <table>
                <tr>
                    <td colspan="3" class="HeaderColor">
                        <h2>Choose a <?php echo ucfirst($org_type); ?> Company for Beneficiary</h2>
                        <hr color="blue">
                    </td>
                </tr>
                ...
                <tr style="vertical-align: top">
                    <td></td>
                    <td colspan="2">
                        <input type="hidden" name="next_page" value="beneficiery.php">
