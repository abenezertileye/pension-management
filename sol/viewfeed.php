...
<div style="float:right;width:70%;margin:auto;">
 <?php 
	   $sqlf="select * from feeds";
       $sqlfr=$mysqli->query($sqlf) or die($mysqli->error);
       if($sqlfr->num_rows>0){
		   while($sqlfeed->fetch_assoc()){
			 echo "<p style='border-top:solid blue 1px;border-bottom:solid blue 1px;width:50%;margin:auto;'>";
			     echo $sqlfeed['fullname']."<br>";  
                 echo $sqlfeed['comment']."<br>"; 				 
		     echo "</p>";   
		   }
	   }	   
