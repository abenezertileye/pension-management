...
if(!isset($_SESSION['user'])){
  ...
  $full_err=$comment_err=$errmsg="";
    if(isset($_POST['submit'])){
	 ...
	 if(empty(empty($comment_err)){
		 $user=$_SESSION['user'];
		 $sqlcreate="insert into feeds(fullname,comment) values('$user','$comment')"; 
...
<div style="float:right;width:70%;margin:auto;">
 ...
 <div >
         <?php echo $errmsg."<br>"; ?>
        <form method="POST"  style="background-color:white;font-family:verdana;font-size:23px;border-radius:15px;padding:20px;line-height:45px;margin-top:50px;">
