  ...
  <table width="99%" border="0" cellpadding="8" cellspacing="10" style="font-family:verdana;font-size:23px;"> 
	...
	<tr style="vertical-align: top"> 
      ...
      <td colspan="2" class="TitleColor"> 
        <input style="width:70%;height:30;" type="text" id="fname" name="fname" />            </td>     
    </tr> 
    <tr style="vertical-align: top"> 
    ...
    <tr style="vertical-align: top"> 
      ...
      <td colspan="2">        <table border="0" cellspacing="2" cellpadding="0"> 
          <tr style="text-align: left"> 
           <td class="TitleColor"> 
              <label for="day"> </label> 
              <input type="date"  id="day" name="dob" min="1980-03-31" max="2002-04-01" style="width:70%;height:30;font-size:25px;" />            </td> 
          </tr> 
        </table>      </td> 
    </tr> 
	<tr style="vertical-align: top"> 
      <td style="text-align: right" class="LabelColor" nowrap="nowrap"> 
        <label for="type"> Type of organization</label>      </td> 
      <td colspan="2" class="TitleColor"> 
	 ...
	 <tr style="vertical-align: top"> 
      ...
      <td colspan="2" class="TitleColor"> 
        <input style="width:70%;height:30;font-size:25px;" type="text" id="nationality" name="nationality" placeholder="Ethiopian"  />          </td> 
    </tr> 
	 	<tr style="vertical-align: top"> 
      <td style="text-align: right;font-size:25px;" class="LabelColor" nowrap="nowrap"> 
        <label for="mstatus"> Maritial Status</label>      </td> 
      <td colspan="2" class="TitleColor"> 
	        <input style="width:70%;height:30;" type="text" id="mstatus" name="mstatus" /> 	         </td> 
    </tr> 
	 	<tr style="vertical-align: top"> 
      <td style="text-align: right;font-size:25px;" class="LabelColor" nowrap="nowrap"> 
        <label for="salary"> Last 3 years avg. salary</label>      </td> 
      <td colspan="2" class="TitleColor"> 
        <label> 
		<input name="salary" type=number style="width:70%;height:30;" max=100000>
	 	...
	 	<tr style="vertical-align: top"> 
      <td style="text-align: right;font-size:25px;" class="LabelColor" nowrap="nowrap" > 
        <label for="status"> Years of service</label>      </td> 
      <td colspan="2" class="TitleColor"> 
        <label> 
